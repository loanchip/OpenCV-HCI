...
def recognize_faces(frame, known_face_encodings, known_face_names):
    ...
    return faces_left, faces_right, faces_top, faces_bottom, faces_names
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if ticker == faces_refresh_rate:
            faces_left, faces_right, faces_top, faces_bottom, faces_names = recognize_faces(frame, known_face_encodings, known_face_names)
            ticker = 0
